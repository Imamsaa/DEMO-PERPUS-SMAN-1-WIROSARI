...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link elevation-4">
      <img src="<?= base_url('public/admin/img/'.$sekolah['logo']); ?>" alt="Sekolah Lumajang" class="brand-image elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel text-center mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= base_url('public/admin/img/pustakawan/'.$aku['foto_user']); ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
