              ...
              <div class="card-body">
                <div class="row my-2">
                  <div class="col-lg-6">
                    ...
                    <a href="<?= base_url('pustakawan/kelas/delall'); ?>" class="btn delete-link btn-danger my-1"><i class="fas fa-solid fa-trash"></i> HAPUS SEMUA</a>
                    <a href="<?= base_url('public/excel/FORMAT IMPORT KELAS.xlsx'); ?>" class="btn btn-success my-1"><i class="fas fa-solid fa-arrow-down"></i>FORMAT EXCEL</a>
                  </div>
                    <div class="col-lg-4">
